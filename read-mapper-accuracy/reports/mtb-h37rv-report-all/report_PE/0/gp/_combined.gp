...
plot \
"report_PE/0/roc/mtb-paired-mapping-report-all.roc" using (($3+$4)/($2+$3+$4)):((($2+$3+$4+$5+$10)/$11)*100) 						with lp ls 1 ps 0.8 title "  mtb-paired-mapping-report-all" noenhanced,\
...
plot \
"report_PE/0/roc/mtb-paired-mapping-report-all.roc" using (($3+$4)/($2+$3+$4)):(($2/($2+$3+$4+$5+$10))*100) 						with lp ls 1 ps 0.8 title "  mtb-paired-mapping-report-all" noenhanced,\
...
plot \
"report_PE/0/roc/mtb-paired-mapping-report-all.roc" using (($3+$4)/($2+$3+$4)):(($2/($2+$4+$10+$7+$9+$5))*100) 						with lp ls 1 ps 0.8 title "  mtb-paired-mapping-report-all" noenhanced,\
...
plot \
"report_PE/0/roc/mtb-paired-mapping-report-all.roc" using (($3+$4)/($2+$3+$4)):((($6+$8)/($7+$6+$9+$8))*100) 						with lp ls 1 ps 0.8 title "  mtb-paired-mapping-report-all" noenhanced,\
...
plot \
"report_PE/0/roc/mtb-paired-mapping-report-all.roc" using (($3+$4)/($2+$3+$4)):((($6+$8)/($6+$8+$3))*100) 						with lp ls 1 ps 0.8 title "  mtb-paired-mapping-report-all" noenhanced,\
